...
#function getExecutor = -> Executors.newSingleThreadExecutor()
...
function getPromise = |executor, task, options| {
  ...
  require(isOptionsPromise(options) , "options must be a hopes.types.optionsPromise")
  # end of contract
...
augment hopes.types.promise {
  ...
  function willWork = |this, arguments| {
